...
describe('People', () => {
    it('should have a string name', () => {
        ...
        [undefined, null, '', ' '].forEach(name => {
            expect(() => new Person(name)).toThrowError(new MissingRequiredParameterError('name'));
        });
        expect(() => new Person(1)).toThrowError(new WrongTypeParameterError('name', 'string'));
    ...
    it('should have a valid animals array', () => {
        ...
        // invalid cases
        expect(() => new Person('John', null)).toThrowError(new MissingRequiredParameterError('animals'));
        expect(() => new Person('John', ["item"])).toThrowError(new WrongTypeParameterError('animals', 'Animal[]'));
    ...
    describe('toString', () => {
        it('should return the person name and animals', () => {
            ...
            expect(people.toString()).toEqual({name: 'John', animals: [{name: 'puppy'}]});
        });
    });
});
