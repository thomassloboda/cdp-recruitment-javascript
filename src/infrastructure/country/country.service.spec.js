...
const {MissingRequiredParameterError} = require("../../core/domain/errors/missing-required-parameter");
...
describe('CountryService', () => {
    ...
    describe('filterCountriesByAnimalName', () => {
        ...
        it('should throw an error if countries input is invalid', () => {
            ...
            expect(() => service.filterCountriesByAnimalName(invalidCountries, 'Zebra'))
                .toThrowError(new WrongTypeParameterError("countries", "Country[]"));
        });

        it('should throw an error if pattern input is invalid', () => {
            expect(() => service.filterCountriesByAnimalName([], '')).toThrowError(new MissingRequiredParameterError("pattern"));
            expect(() => service.filterCountriesByAnimalName([], 1)).toThrowError(new WrongTypeParameterError("pattern", "string"));
        })
